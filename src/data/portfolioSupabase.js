...
export async function fetchPortfolioProjectsFromSupabase() {
  ...
  return (projects || []).map(project => {
    ...
    return {
      id: project.id, name: project.title, slug: project.slug, short: project.short_description,
      full: project.description, techs: mapTechnologies(project.technologies), liveDemoUrl: project.live_url,
      githubUrl: project.github_url, featured: project.featured, order: project.sort_order, createdAt: project.created_at,
      images: projectImages, coverImage,
    }
  })
}
